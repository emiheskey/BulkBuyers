<?php
    ...
    Route::group(["prefix"=>"app/admin"], function (){
        ...
        Route::group(['prefix'=>'product'], function (){
            ...
            Route::get('/offline','Admin\ProductController@offline')->name('offline.product');
        });

        Route::group(['prefix'=>'cart'], function (){
            Route::get('cart', 'Admin\CartController@cart')->name('offline.cart');
        ...
        Route::get('/{id}/category/edit','Admin\ProductcategoryController@edit')->name('edit.category');
        Route::post('/{id}/category/edit/post','Admin\ProductcategoryController@update')->name('edit.category.post');
