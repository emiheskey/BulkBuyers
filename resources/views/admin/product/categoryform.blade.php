        ...
        <form method="POST" action="{{ route('post.category') }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-form-label" for="productcatimg">Category image</label>
                    <div class="col-sm-12">
                        <input type="file" class="form-control" id="productcatimg" name="productcatimg" required>
                        @error('productcatimg')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
