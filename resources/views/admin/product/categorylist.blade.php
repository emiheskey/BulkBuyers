            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    @forelse($category as $list)
                        ...
                        <tr>
                            <td>{{++$count}}</td>
                            <td class="text-capitalize"><img src="{{asset($list->productcatimg)}}" width="50" class="img-fluid img-circle">
                                {{$list->prodcatname}}</td>
                            <td>
...
">
                            ...
                            <td>
                                <a href="{{route('edit.category',$list->prodcatid)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                @if($list->status > 0)
